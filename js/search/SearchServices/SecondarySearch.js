    ...
    if (searchParams.ingredients.length > 0) {
      recipes.forEach((recipe) => {
        ...
        searchParams.ingredients.forEach((element) => {
          isFound &= recipe.ingredients.findIndex((ingredient) => ingredient.ingredient.indexOf(element) > -1) > -1;
        });
        if (isFound) {
    ...
    if (searchParams.appareils.length > 0) {
      recipes.forEach((recipe) => {
        ...
        searchParams.appareils.forEach((element) => {
          isFound &= recipe.appliance.findIndex((appareil) => appareil.indexOf(element) > -1) > -1;
        });
        if (isFound) {
    ...
    if (searchParams.ustensiles.length > 0) {
      recipes.forEach((recipe) => {
        ...
        searchParams.ustensiles.forEach((element) => {
          isFound &= recipe.ustensils.findIndex((ustensile) => ustensile.indexOf(element) > -1) > -1;
        });
        if (isFound) {
